        ...
        {steps.map((step, index) => (
          ...
          >
            ...
            <div className="flex flex-col items-center mb-6">
              <div className="bg-gray-200 text-gray-800 font-semibold rounded-full w-10 h-10 flex items-center justify-center mb-3">
                {step.number}
              </div>

              {/* ---------- Icon ---------- */}
              <div className="bg-primary p-4 rounded-full shadow-lg flex items-center justify-center">
                {step.icon}
              </div>
            </div>
            ...
            <div className="bg-white shadow-md rounded-xl p-6 border border-gray-100 text-center">
              ...
              <p className="text-[#2A9AA5] font-semibold mt-1">
                {step.subtitle}
              </p>
              <p className="text-gray-600 mt-3 text-sm leading-relaxed text-left">
                {step.description}
              </p>
              <ul className="text-gray-600 text-sm mt-3 space-y-1 text-left list-disc list-inside">
